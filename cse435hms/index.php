	...
	<div class="row">
    	<div class="col-sm-12">
        	<div class="header bg-white">            		
            			<h3 style="background-color: rgb(22,22,22); padding:20px;color:#FFFFFF;margin:0px">
	<span>Hello <?php echo $s['username']; echo " !";?></span>
							<span style="font-size:15px; color:white";><?php
                            $Today=date('y:m:d');
    ...
    <div class="row">
    	<div class="col-sm-12">
        	<div class="footer bg-white">
            	<div class="copyright">
                	<p align="center" style="padding-top:10px;">Copyright &copy; CSE435 Team -Seekers 2018 &nbsp;&nbsp;&nbsp;<span style="background-color: rgb(22,22,22);"></span></p>
                </div>
            </div>
        </div>
    </div>
